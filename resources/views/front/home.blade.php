    ...
    <div class="container">
        <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
            <ul>
                ...
                <li data-index="rs-1588" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="{{asset('front/img/home-slider/slider-2.jpg')}}" data-rotate="0" data-saveperformance="off" data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('front/img/home-slider/s-l1600.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    <!-- LAYERS -->
                    ...
                    <div class="slider_text_box">
                        ...
                        <div class="tp-caption tp-resizeme secand_text" data-x="['right','right','right','center','center',]" data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']" data-voffset="['255','255','255','230','220']" data-fontsize="['48','48','48','48','36']" data-lineheight="['52','52','52','46']" data-width="['450','450','450','450','450']" data-height="none" data-whitespace="normal" data-type="text" data-responsive_offset="on" data-transform_idle="o:1;" data-frames="[{&quot;delay&quot;:10,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;&quot;,&quot;mask&quot;:&quot;x:0px;y:[100%];s:inherit;e:inherit;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;y:[175%];&quot;,&quot;mask&quot;:&quot;x:inherit;y:inherit;s:inherit;e:inherit;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;}]" data-textAlign="['left','left','left','left','left','center']">Best Parts <br />Collection
                        </div>
        ...
        <div class="row feature_inner">
            <div class="col-lg-4">
                <div class="f_add_item">
                    <div class="f_add_img"><img class="img-fluid" src="{{asset('front/img/feature-add/rsz_2020-aprilia-rs-660-3qtr.jpg')}}" alt=""></div>
            ...
            <div class="item">
                <div class="l_product_item">
                    ...
                    <div class="l_p_text">
                        <ul>
                            ...
                            <li><a class="add_cart_btn" onclick="addToCart('{{$products[0]->id}}','{{$products[0]->price}}')" href="javascript:void(0);">Add To Cart</a></li>
                ...
                <div class="l_product_item">
                    ...
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                            <li><a class="add_cart_btn" onclick="addToCart('{{$products[1]->id}}','{{$products[1]->price}}')" href="javascript:void(0);">Add To Cart</a></li>
                            <li class="p_icon"><a href="#"><i class="icon_heart_alt"></i></a></li>
                        </ul>
            ...
            <div class="item">
                <div class="l_product_item">
                    ...
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                            <li><a class="add_cart_btn" onclick="addToCart('{{$products[2]->id}}','{{$products[2]->price}}')" href="javascript:void(0);">Add To Cart</a></li>
                            <li class="p_icon"><a href="#"><i class="icon_heart_alt"></i></a></li>
                        </ul>
                ...
                <div class="l_product_item">
                    ...
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                            <li><a class="add_cart_btn" onclick="addToCart('{{$products[3]->id}}','{{$products[3]->price}}')" href="javascript:void(0);">Add To Cart</a></li>
                            <li class="p_icon"><a href="#"><i class="icon_heart_alt"></i></a></li>
                        </ul>
            ...
            <div class="item">
                <div class="l_product_item">
                    ...
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                            <li><a class="add_cart_btn" onclick="addToCart('{{$products[4]->id}}','{{$products[4]->price}}')" href="javascript:void(0);">Add To Cart</a></li>
                            <li class="p_icon"><a href="#"><i class="icon_heart_alt"></i></a></li>
                        </ul>
                ...
                <div class="l_product_item">
                    ...
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                            <li><a class="add_cart_btn" onclick="addToCart('{{$products[5]->id}}','{{$products[5]->price}}')" href="javascript:void(0);">Add To Cart</a></li>
                            <li class="p_icon"><a href="#"><i class="icon_heart_alt"></i></a></li>
                        </ul>
            ...
            <div class="item">
                <div class="l_product_item">
                    ...
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                            <li><a class="add_cart_btn" onclick="addToCart('{{$products[6]->id}}','{{$products[6]->price}}')" href="javascript:void(0);">Add To Cart</a></li>
                            <li class="p_icon"><a href="#"><i class="icon_heart_alt"></i></a></li>
                        </ul>
                ...
                <div class="l_product_item">
                    ...
                    <div class="l_p_text">
                        <ul>
                            <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                            <li><a class="add_cart_btn" onclick="addToCart('{{$products[7]->id}}','{{$products[7]->price}}')" href="javascript:void(0);">Add To Cart</a></li>
                            <li class="p_icon"><a href="#"><i class="icon_heart_alt"></i></a></li>
                        </ul>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="f_add_item white_add">
                        <div class="f_add_img"><img class="img-fluid" src="{{asset('front/img/feature-add/f-add-4.jpg')}}" alt=""></div>
                        <div class="f_add_hover">
                ...
                <div class="col-lg-6">
                    <div class="f_add_item white_add">
                        <div class="f_add_img"><img class="img-fluid" src="{{asset('front/img/feature-add/f-add-5.jpg')}}" alt=""></div>
                        <div class="f_add_hover">
                            <h4>Best Summer <br />Collection</h4>
                            <a class="add_btn" href="#">Shop Now <i class="arrow_right"></i></a>
                        </div>
            ...
            <div class="row p_listing_inner">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-4">
                            <div class="p_list_img">
                                <img src="{{asset('front/img/product/p-categories-list/product-l-1.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-4">
                            <div class="p_list_img">
                                <img src="{{asset('front/img/product/p-categories-list/product-l-2.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-4">
                            <div class="p_list_img">
                                <img src="{{asset('front/img/product/p-categories-list/product-l-3.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="feature_product_area">
    <div class="container">
                ...
                <div class="col-lg-3">
                    <div class="f_product_left">
                        ...
                        <div class="f_product_inner">
                            @for ($i = 0; $i<3; $i++) <a href="{{route('view_product', $lProducts[$i]->id)}}">
                                <div class="media">
                                    <div class="d-flex">
                    ...
                    <div class="media">
                        <div class="d-flex">
                            <img src="{{asset('front/img/product/featured-product/f-p-3.jpg')}}" alt="">
                        </div>
                        <div class="media-body">
                            <h4>Leather Bag</h4>
                            <h5>$45.05</h5>
                    ...
                    <div class="media">
                        <div class="d-flex">
                            <img src="{{asset('front/img/product/featured-product/f-p-4.jpg')}}" alt="">
                        </div>
                        <div class="media-body">
                            <h4>Casual Shoes</h4>
                            <h5>$45.05</h5>
        ...
        <div class="item woman shoes">
            <div class="fillter_product_item">
                <div class="f_p_img">
                    <img src="{{asset('front/img/product/fillter-product/f-product-3.jpg')}}" alt="">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        <div class="from_blog_item">
                            <img class="img-fluid" src="{{asset('front/img/blog/from-blog/f-blog-1.jpg')}}" alt="">
...
<div class="col-lg-4 col-sm-6">
    <div class="from_blog_item">
        <img class="img-fluid" src="{{asset('front/img/blog/from-blog/f-blog-2.jpg')}}" alt="">
        <div class="f_blog_text">
            <h5>fashion</h5>
            <p>Neque porro quisquam est qui dolorem ipsum</p>
            <h6>21.09.2017</h6>
...
<div class="col-lg-4 col-sm-6">
    <div class="from_blog_item">
        <img class="img-fluid" src="{{asset('front/img/blog/from-blog/f-blog-3.jpg')}}" alt="">
        <div class="f_blog_text">
            <h5>fashion</h5>
            <p>Neque porro quisquam est qui dolorem ipsum</p>
            <h6>21.09.2017</h6>
