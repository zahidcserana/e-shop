        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="m-portlet">
                    ...
                    @endif
                <!--begin::Form-->
                    <form class="m-form" name="color-form" method="POST" action="{{route('color')}}">
                        {{ csrf_field() }}
                        <div class="m-portlet__body">
                            <div class="m-form__section m-form__section--first">
                                <input type="hidden" name="id" value="{{$color->id or ''}}">
                                ...
                                <table class="table m-table m-table--head-bg-success">
                                    ...
                                    @foreach($colors as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('/color',$row->id)}}">Edit</a>|
                                                <a href="{{url('/color-delete',$row->id)}}">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
